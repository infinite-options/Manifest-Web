...
class FutureModal extends React.Component {
  ...
  grabFireBaseAllPeopleNames = () => {
    let url1 =
      "https://gyn3vgy3fb.execute-api.us-west-1.amazonaws.com/dev/api/v2/motivation/";

    let url2 =
      "https://gyn3vgy3fb.execute-api.us-west-1.amazonaws.com/dev/api/v2/feelings/";

    let url3 =
      "https://gyn3vgy3fb.execute-api.us-west-1.amazonaws.com/dev/api/v2/happy/";

    let url4 =
      "https://gyn3vgy3fb.execute-api.us-west-1.amazonaws.com/dev/api/v2/important/";
  ...
  newInputSubmit = () => {
    ...
    let motivationUrl = "https://gyn3vgy3fb.execute-api.us-west-1.amazonaws.com/dev/api/v2/updateMotivation";
    let feelingsUrl = "https://gyn3vgy3fb.execute-api.us-west-1.amazonaws.com/dev/api/v2/updateFeelings";
    let importantUrl = "https://gyn3vgy3fb.execute-api.us-west-1.amazonaws.com/dev/api/v2/updateImportant";
    let happyUrl = "https://gyn3vgy3fb.execute-api.us-west-1.amazonaws.com/dev/api/v2/updateHappy";
